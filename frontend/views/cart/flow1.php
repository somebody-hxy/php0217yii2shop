...
<div class="mycart w990 mt10 bc">
        ...
        <tbody>
            <?php foreach($models as $model):?>
                <tr data-goods_id="<?=$model['id']?>">
                    <td class="col1"><a href=""><?=Html::img('http://admin.yii2shop.com'.$model['logo'])?></a>
                        <strong><?=Html::a($model['name'])?></strong></td>
    ...
    <div class="cart_btn w990 bc mt10">
        ...
        <?=Html::a('结 算',['cart/flow2'],['class'=>'checkout'])?>
    </div>
</div>
<!-- 主体部分 end    -->

<?php
$url = \yii\helpers\Url::to(['cart/update-flow1']);
...
$this->registerJs(new \yii\web\JsExpression(
    <<<JS
        ...
        $(".reduce_num,.add_num").click(function(){
            ...
            //发送ajax post请求到cart/update-flow1  {goods_id,amount}
