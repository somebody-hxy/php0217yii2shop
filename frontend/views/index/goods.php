            ...
            <dl>
                ...
                <dd>
                    ...
                    <div class="viewlist mt10">
                        <h3>最近浏览的商品：</h3>
                        <ul>
                            <li><a href=""><?=Html::a('@web/images/view_list1.jpg')?></a></li>
                            <li><a href=""><?=Html::a('@web/images/view_list2.jpg')?></a></li>
                            <li><a href=""><?=Html::a('@web/images/view_list3.jpg')?></a></li>
                        </ul>
                    </div>
                </dd>
            </dl>
...
<div class="summary">
    <?php //foreach($goods1 as $good_list):?>
    <h3><strong><?=$goods1->name?></strong></h3>
